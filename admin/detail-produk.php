                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Daftar Detail Produk</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody class="table-border text-center align-middle text-wrap">
                                            <?php $no = 1;
                                            $data_array = $clientDetail->tampil_semua_detail_produk();
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="col-2 text-center">
                                                        <a class="btn btn-outline-primary btn-sm" type="button" a href="ubah-detail-produk.php?id_detail=<?= $r->id_detail ?>"><i class="fas fa-edit"></i> Ubah</a>
                                                        <a class="btn btn-outline-danger btn-sm" type="button" a href="proses-detail-produk.php?aksi=hapus&id_detail=<?= $r->id_detail ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini?')"><i class="fas fa-trash-alt"></i> Hapus</a>
                                                    </td>
