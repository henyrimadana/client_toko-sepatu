            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="produk.php" role="button"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="detail-produk.php" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">Detail Produk</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="kategori.php" role="button"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" id="navbarDropdown" href="pelanggan.php"
                            role="button" data-bs-toggle="dropdown" aria-expanded="false">Pelanggan</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <div class="main-1">
            ...
            <form name="form" class="container" method="POST" action="proses-pelanggan.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="id_pelanggan" id="formGroupExampleInput"
                        value="<?= $r->id_pelanggan ?>" disabled>
                </div>

                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Nama Pelanggan</label>
                    <input type="text" class="form-control" name="nama" id="formGroupExampleInput2"
                        value="<?= $r->nama ?>" required>
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Alamat</label>
                    <input type="text" class="form-control" name="alamat" id="formGroupExampleInput2"
                        value="<?= $r->alamat ?>" required>
                </div>

                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">No HP</label>
                    <input type="text" class="form-control" name="no_hp" id="formGroupExampleInput2"
