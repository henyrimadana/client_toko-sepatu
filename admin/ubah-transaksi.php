        ...
        <div class="main-1">
            ...
            <form name="form" class="container" method="POST" action="proses-transaksi.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="id_produk" id="formGroupExampleInput" value="<?= $r->id_produk ?>" disabled>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="tanggal" id="formGroupExampleInput2" value="<?= $r->tanggal ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Jumlah</label>
                    <input type="text" class="form-control" name="jumlah" id="formGroupExampleInput2" value="<?= $r->jumlah ?>" disabled>
                </div>
                <div class="col-auto">
