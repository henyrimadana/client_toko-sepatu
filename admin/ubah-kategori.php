...
<head>
    ...
    <title>Ubah Kategori - Admin</title>
...
<body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" id="navbarDropdown" href="kategori.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">Kategori</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
    ...
    <header class="bg-dark py-2">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Edit kategori</h1>
    ...
    <section class="py-5">
        <div class="main-1">
            <?php
            $r = $clientKategori->tampil_kategori($_GET['id_kategori']);
            ?>
            <form name="form" class="container" method="POST" action="proses-kategori.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="id_kategori" id="formGroupExampleInput" value="<?= $r->id_kategori ?>" disabled>
                </div>

                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Nama kategori</label>
                    <input type="text" class="form-control" name="nama_kategori" id="formGroupExampleInput2" value="<?= $r->nama_kategori ?>">
                </div>

                <div class="col-auto">
                    <button type="submit" name="ubah" class="btn btn-primary">Edit kategori</button>
                </div>
            </form>
        </div>
